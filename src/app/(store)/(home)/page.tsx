    ...
    return (
        <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
            <Link
                ...
                className="group col-span-6 row-span-6 rounded-lg bg-zinc-900 overflow-hidden flex justify-center relative"
            >
                <Image
            ...
            {otherProducts.map((product) => (
                <Link
                    ...
                    className="group col-span-3 row-span-3 rounded-lg bg-zinc-900 overflow-hidden flex justify-center relative"
                    key={product?.id}
                >
                    <Image
                        src={product?.image}
